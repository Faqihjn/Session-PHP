<?php
    ...
    class Inventory {
        ...
        function update($id, $name, $stock, $expired_at, $updated_at){
            $query = "UPDATE `inventory` SET `name` = ?, `stock` = ?, `expired_at` = ?, `updated_at` = now()  WHERE id = ?";
